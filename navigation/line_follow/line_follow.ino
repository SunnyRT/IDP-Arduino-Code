...
void loop() {
  ...
  //  else if(OnOff_state == true) {


  //line detected by l0, l1, l2
  if (forward_flag == false && 
  (((l0 == LOW) && (l1 == LOW) && (l2== LOW))
  ||((l0 == HIGH) && (l1 == LOW) && (l2== HIGH)))) {
    //forward
    forward_flag = true;
    Lturn_flag = false;
    Rturn_flag = false;
  ...
  //l0 detects no line
    ...
    else if (Lturn_flag == true) {
      adjust_right();
    }
    else if (Rturn_flag == true) {
      adjust_left();
    }
  }
  //  }
